// Adapted from https://github.com/preactjs/preact

export as namespace joedom;
...
export type ComponentChild = ComponentChildType | Promise<ComponentChildType>;
...
export interface ComponentAttributes<T> extends Attributes {
  ref?: Ref<T>;
}

export interface JOEDOMAttributes {
...
export interface ClientComponent<P> {
  (props: RenderableProps<P>, context?: any): ComponentChild;
  $$typeof: symbol;
  $$id: string | number;
}

export type ComponentType<P = {}> = FunctionComponent<P> | ClientComponent<P>;
...
export interface FunctionComponent<P = {}> {
  ...
  fallback?: FunctionComponent<P> | undefined;
}
...
export function createElement(
  ...
  props:
    | (JSXInternal.DOMAttributes<HTMLInputElement> &
        ComponentAttributes<HTMLInputElement>)
    | null,
  ...children: ComponentChildren[]
): VNode<any>;
export function createElement<
...
>(
  ...
  props: (ComponentAttributes<T> & P) | null,
  ...children: ComponentChildren[]
): VNode<any>;
export function createElement<
...
export interface JOEConsumer<T> extends Consumer<T> {}
...
export interface JOEProvider<T> extends Provider<T> {}
...
export interface JOEContext<T> extends Context<T> {}
